...
window.I18N = {
  ko: {
    ...
    detail_ach_kind:'영구 업적', detail_end_kind:'엔딩 도감',
    detail_locked_name:'? ? ?', detail_unlock:'🔒 해금 조건',
    detail_ach_done:'✅ 획득 완료', detail_end_done:'✅ 도달한 엔딩',
    detail_locked_tag:'🔒 미해금', detail_close:'닫기',
    /* ── 인게임 크롬 ── */
  ...
  en: {
    ...
    "detail_ach_kind":"Achievement","detail_end_kind":"Ending Dex",
    "detail_locked_name":"? ? ?","detail_unlock":"🔒 Unlock Condition",
    "detail_ach_done":"✅ Unlocked","detail_end_done":"✅ Ending Reached",
    "detail_locked_tag":"🔒 Locked","detail_close":"Close",
